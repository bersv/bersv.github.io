...
6. Проверять сумму штрафа:
   - Если сумма штрафа свыше 5_000 рублей записать в __Таблицу__ с флагом _True_.
   - Если сумма штрафа не превышает 5_000 рублей записать в __Таблицу__ с флагом _False_.
