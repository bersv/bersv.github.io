# Анализ базы данных по авиаперевозкам
...
3. Выведите названия самолетов не имеющих бизнес-класс. Решение должно быть через функцию _array_agg_.
